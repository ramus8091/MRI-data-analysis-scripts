#!/usr/bin/env python3
"""
batch_t2_decay.py (with T2 uncertainty error bars)
...
def main():
    ...
    # Locate calibration reference. # Update this root directory to the folder your working in
    candidates = [
    ...
    # Summary plot: T₂ vs time with uniform Y-limits + error bars and Sw annotations
